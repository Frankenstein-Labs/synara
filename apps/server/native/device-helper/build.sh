#!/bin/bash
# Compiles cortex-device-helper with the user's own Xcode toolchain.
#
...
#   CORTEX_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${CORTEX_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="cortex-device-helper"
