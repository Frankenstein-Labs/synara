...
typedef NS_ENUM(NSInteger, CortexHardwareButton) {
  CortexHardwareButtonHome,
  CortexHardwareButtonLock,
  CortexHardwareButtonSide,
  CortexHardwareButtonSiri,
  CortexHardwareButtonVolumeUp,
  CortexHardwareButtonVolumeDown,
};
...
@interface CortexHIDBridge : NSObject
...
- (void)tapButton:(CortexHardwareButton)button NS_SWIFT_NAME(tapButton(_:));
