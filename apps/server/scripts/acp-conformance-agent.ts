...
const logPath = process.env.CORTEX_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.CORTEX_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "cortex-official-sdk-conformance-agent" })
