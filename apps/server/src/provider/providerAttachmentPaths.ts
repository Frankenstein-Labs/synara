...
import type { ChatAttachment, ProviderKind, ThreadId } from "@cortex/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("cortex.providerAttachmentStoragePath");
