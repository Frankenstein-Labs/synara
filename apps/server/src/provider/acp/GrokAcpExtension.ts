import type { ProviderUserInputAnswers, UserInputQuestion } from "@cortex/contracts";
...
const CORTEX_PLAN_REVIEW_FEEDBACK =
...
/**
 * Cortex owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: CORTEX_PLAN_REVIEW_FEEDBACK,
  };
}

/** Cortex has already received an implementation turn, so Grok may leave its native gate. */
