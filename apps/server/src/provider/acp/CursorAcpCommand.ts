...
import { executableCandidates, executableNameCandidates } from "@cortex/shared/executable";
...
// Resolves persisted/default Cursor binary settings into the executable Cortex should spawn.
