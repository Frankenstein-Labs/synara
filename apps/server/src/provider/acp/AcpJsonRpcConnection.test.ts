    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "cortex-test", version: "0.0.0" },
          authMethodId: "test",
          requestLogger: (event) =>
            Effect.sync(() => {
  ...
  it.effect("forwards provider session metadata when creating a session", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(sessionStarted?.payload).toMatchObject({
        _meta: {
          "x.ai/hooks": {
            PreToolUse: [{ matcher: "*", hookCallbackIds: ["cortex-plan-guard"] }],
          },
        },
      });
    }).pipe(
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_FAIL_SESSION_NEW_ONCE: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
        ...
        Effect.provide(
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_ADVERTISE_AUTH_METHODS: "1",
                CORTEX_ACP_REQUIRE_AUTH_FOR_SESSION: "1",
                CORTEX_ACP_EMIT_ORPHAN_UPDATE: "1",
                CORTEX_ACP_EMIT_AVAILABLE_COMMANDS: "1",
                CORTEX_ACP_ORPHAN_UPDATE_DELAY_MS: "50",
                CORTEX_ACP_FINAL_SESSION_DELAY_MS: "150",
              },
            },
            cwd: process.cwd(),
            clientInfo: { name: "cortex-test", version: "0.0.0" },
        ...
        Effect.provide(
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "0,0",
                CORTEX_ACP_LOAD_REPLAY_MODE_ID: "code",
                CORTEX_ACP_REJECT_PROMPT_DURING_LOAD_REPLAY: "1",
              },
            },
            cwd: process.cwd(),
        ...
        Effect.provide(
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "10,25",
                CORTEX_ACP_LOAD_REPLAY_MODE_ID: "code",
              },
            },
            cwd: process.cwd(),
          ...
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "10,25",
                CORTEX_ACP_REJECT_CONFIG_DURING_LOAD_REPLAY: "1",
              },
            },
            cwd: process.cwd(),
            resumeSessionId: "mock-session-1",
          ...
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "10,25",
                CORTEX_ACP_LOAD_REPLAY_AVAILABLE_COMMANDS: "1",
              },
            },
            cwd: process.cwd(),
            resumeSessionId: "mock-session-1",
    ...
    const layerFor = (resumeSessionId?: string) =>
      AcpSessionRuntime.layer({
        spawn: {
          command: bunExe,
          args: [mockAgentPath],
          env: { VITEST: "true", CORTEX_ACP_SUPPORT_SESSION_RESUME: "1" },
        },
        cwd: process.cwd(),
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { VITEST: "true", CORTEX_ACP_SUPPORT_SESSION_LOAD: "0" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          clientInfo: { name: "cortex-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_SUPPORT_SESSION_FORK: "1",
              CORTEX_ACP_EMIT_AVAILABLE_COMMANDS: "1",
              CORTEX_ACP_MODE_CONFIG_ID: "autonomy_level",
            },
          },
          cwd: process.cwd(),
        ...
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_SUPPORT_SESSION_FORK: "1",
              CORTEX_ACP_SUPPORT_SESSION_LOAD: "0",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
          ...
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                ...
                CORTEX_ACP_SUPPORT_SESSION_FORK: "1",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "10,25",
                CORTEX_ACP_REJECT_FORK_DURING_LOAD_REPLAY: "1",
              },
            },
            cwd: process.cwd(),
            resumeSessionId: "mock-session-1",
          ...
          AcpSessionRuntime.layer({
            spawn: {
              ...
              env: {
                VITEST: "true",
                CORTEX_ACP_SUPPORT_SESSION_FORK: "1",
                CORTEX_ACP_LOAD_REPLAY_DELAYS_MS: "0,50,100,150,199",
              },
            },
            cwd: process.cwd(),
            resumeSessionId: "mock-session-1",
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_EMIT_UPSTREAM_ASSISTANT_MESSAGE_IDS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_EMIT_REASONING_THEN_TOOL_CALL: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            env: {
              VITEST: "true",
              CORTEX_ACP_REQUEST_LOG_PATH: requestLogPath,
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "cortex-test", version: "0.0.0" },
