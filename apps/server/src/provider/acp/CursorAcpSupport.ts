 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@cortex/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@cortex/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Cortex's "auto"
...
function collectCursorAcpConfigUpdates(
  ...
  // Cursor's persisted/current preference can be true even when Cortex has no
