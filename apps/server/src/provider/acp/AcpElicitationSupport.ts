...
// Purpose: Bridges ACP form elicitation schemas to Cortex's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Cortex's composer.
