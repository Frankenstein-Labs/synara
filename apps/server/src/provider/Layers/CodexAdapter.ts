...
import { cortexSkillsDir } from "../skillsCatalog.ts";
...
// Generous by design; override with CORTEX_CODEX_TURN_IDLE_TIMEOUT_MS.
const CODEX_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "CORTEX_CODEX_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 900_000,
});
      ...
      Effect.gen(function* () {
        ...
        return (
          ...
          new CodexAppServerManager(services, {
            cortexSkillsDir: cortexSkillsDir(serverConfig.baseDir),
