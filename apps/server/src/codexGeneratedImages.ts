...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@cortex/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Cortex uses its isolated
 ...
 * overlay `<CORTEX_HOME>/codex-home-overlay/generated_images` so we serve
