 ...
 * names. Because the migrator skips by ID, Cortex migrations 17-31 never run
 ...
 * Cortex migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Cortex installs (every column already
