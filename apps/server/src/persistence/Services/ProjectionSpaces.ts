...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@cortex/contracts";
...
>()("cortex/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
