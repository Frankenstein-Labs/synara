import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@cortex/contracts";
...
>()(
  "cortex/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
