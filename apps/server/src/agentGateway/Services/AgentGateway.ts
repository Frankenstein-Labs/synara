/**
 * AgentGateway - Cortex app-control tool surface for provider agents.
 *
 * Serves the `cortex_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Cortex itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "cortex/agentGateway/Services/AgentGateway",
) {}
