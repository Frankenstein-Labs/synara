/**
 * AgentGatewayCredentials - Per-session credentials for the Cortex agent
 * gateway.
 *
 ...
 */
import type { ProviderKind, ThreadId } from "@cortex/contracts";
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Cortex instance. */
...
>()("cortex/agentGateway/Services/AgentGatewayCredentials") {}
