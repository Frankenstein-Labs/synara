...
import type { ModelSelection, ProviderKind, ProviderModelDescriptor } from "@cortex/contracts";
...
describe("agent gateway target resolver", () => {
  ...
  it.effect("fails closed before discovery when Cortex disables a provider", () =>
    Effect.gen(function* () {
