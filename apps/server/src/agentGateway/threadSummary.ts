 ...
 * `cortex_list_threads`, and truncated/paginated message views for
 * `cortex_read_thread`. Kept pure so the shaping rules are unit-testable.
 *
...
import { splitsSurrogatePair, unicodeSafeEndOffset } from "@cortex/shared/text";
