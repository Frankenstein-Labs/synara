...
import { ProjectId, ThreadId, TurnId, type OrchestrationCommand } from "@cortex/contracts";
...
const PROMPT = "Cortex was closed while this chat was still running. Continue where you left off.";
