import { ApprovalRequestId, CommandId, type OrchestrationEvent } from "@cortex/contracts";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isStalePendingRequestFailureDetail } from "@cortex/shared/threadSummary";
