import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@cortex/contracts";
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Cortex thread id and the child identity
