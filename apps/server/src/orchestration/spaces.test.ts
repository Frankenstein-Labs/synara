...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@cortex/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/Cortex/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "Cortex",
      workspaceRoot: "/Users/dev/code/cortex",
      createdAt,
    }));
