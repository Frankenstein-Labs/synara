...
// Purpose: Normalizes provider-native transcript snapshots into Cortex import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@cortex/contracts";
