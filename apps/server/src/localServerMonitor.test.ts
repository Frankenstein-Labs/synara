...
describe("localServerMonitor", () => {
  ...
  it("keeps dev servers and ignores Electron/Cortex-style application listeners", () => {
    expect(
      detectDevServerKindFromText({
        command: "node",
    ...
    expect(
      isIgnoredLocalServerProcess({
        command: "Electron",
        args: "/Applications/Cortex.app/Contents/MacOS/Cortex",
        ports: [61449],
      }),
    ).toBe(true);
    expect(
    ...
    expect(
      detectDevServerKindFromText({
        command: "node",
        args: "node /Users/emanueledipietro/Developer/cortex/apps/web/node_modules/.bin/vite",
        ports: [5733],
      }),
    ).toBe("Vite");
    expect(
    ...
    const processInfo = new Map<number, LocalServerProcessInfo>([
      ...
      [
        12094,
        {
          ppid: 12064,
          commandLine:
            "node /Users/emanueledipietro/Developer/cortex-website/node_modules/.bin/next dev",
        },
      ],
      [
        12064,
