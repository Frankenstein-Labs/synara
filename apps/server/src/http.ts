...
import { EDITOR_ICON_ROUTE_PATH } from "@cortex/shared/editorIcons";
        ...
        return HttpServerResponse.jsonUnsafe(
          { error: authorization.reason === "unavailable" ? "Not Found" : "Unauthorized" },
          {
            ...
            ...(authorization.status === 401
              ? { headers: { "WWW-Authenticate": 'Bearer realm="cortex-desktop-shutdown"' } }
              : {}),
          },
        );
      }
...
const threadExportEffectRouteLayer = HttpRouter.add(
  ...
  Effect.gen(function* () {
    ...
    // app fetches cross-origin (cortex://app), and without them the browser masks
