...
// Uses synthetic content and its own Electron profile; never connects to Cortex or a provider.
...
</style><aside><strong>Cortex</strong><div style="margin-top:30px;display:flex;gap:10px;align-items:center">
...
app.whenReady().then(() => {
 const win = new BrowserWindow({width:1200,height:850,title:"Cortex performance fixture",show:true,
