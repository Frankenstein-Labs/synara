...
// Exposes: window.__cortexPipelinePerf { runStream, runQuiet, scrollCycle, snapshot, resetMetrics }
//
// URL params:
...
import { MessageId, ThreadId, TurnId } from "@cortex/contracts";
...
createRoot(rootElement).render(
  <StrictMode>
    <Profiler id="cortex-pipeline-perf" onRender={handleRender}>
      <PipelineHarness />
    </Profiler>
  </StrictMode>,
);
