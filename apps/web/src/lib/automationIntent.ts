...
// Purpose: Detects when a normal chat prompt is actually asking Cortex to create an automation.
...
import { completionPolicyFromStopWhen } from "@cortex/shared/automationCompletionPolicy";
