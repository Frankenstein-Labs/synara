...
import type { ToolLifecycleItemType } from "@cortex/contracts";
import { stripTrailingToolExitCode as stripTrailingExitCode } from "@cortex/shared/toolOutputSummary";
...
function extractToolOutputDetails(input: {
  ...
  const truncated = rawOutput?.truncated === true || data?.__cortexTruncated === true;
