...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "cortex:cursor-favourite-models:v1",
  opencode: "cortex:opencode-favourite-models:v1",
  pi: "cortex:pi-favourite-models:v1",
} as const;

const LEGACY_KILO_FAVORITE_MODEL_STORAGE_KEY = "cortex:kilo-favourite-models:v1";
