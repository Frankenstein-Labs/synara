...
import { ThreadId, type ServerConfig, type ServerProviderStatus } from "@cortex/contracts";
...
function makeServerConfig(providers: readonly ServerProviderStatus[]): ServerConfig {
  return {
    ...
    chatWorkspaceRoot: "C:\\Users\\tester\\Documents\\Cortex",
    studioWorkspaceRoot: "C:\\Users\\tester\\Documents\\Cortex\\Studio",
    worktreesDir: "C:\\CortexDev\\worktrees",
    keybindingsConfigPath: "C:\\CortexDev\\keybindings.json",
    keybindings: [],
    issues: [],
    providers,
    availableEditors: [],
...
describe("serverLocalServersQueryOptions", () => {
  ...
  it("uses visible polling while a Cortex-owned project run is active", () => {
    const options = sidebarLocalServersQueryOptions({
