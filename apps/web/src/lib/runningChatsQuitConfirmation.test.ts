...
describe("running chats quit confirmation", () => {
  ...
  it("builds singular and plural English copy", () => {
    expect(runningChatsQuitCopy([{ id: "a", title: "Fix the tray" }])).toEqual({
      ...
      description: "Work in progress will stop when Cortex is closed.",
    ...
    expect(
      ...
      description: "Work in progress will stop when Cortex Canary is closed.",
  ...
  it("builds the continuation prompt from the app name", () => {
    expect(quitResumeContinuationPrompt()).toBe(
      "Cortex was closed while this chat was still running. Continue where you left off.",
    );
    expect(quitResumeContinuationPrompt("Cortex Canary")).toBe(
      "Cortex Canary was closed while this chat was still running. Continue where you left off.",
    );
  });
