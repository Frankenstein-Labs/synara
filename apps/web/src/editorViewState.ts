...
import type { ProjectId, ProviderKind, ThreadId } from "@cortex/contracts";
import { isProviderKind } from "./providerOrdering";

const EDITOR_VIEW_STATE_STORAGE_KEY = "cortex.editor.viewStateByThreadId";
const EDITOR_RAIL_CHAT_TABS_STORAGE_KEY = "cortex.editor.railChatTabsByProjectId";
