...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@cortex/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Cortex so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Cortex has no registry to read a latest
  ...
  it("keeps prompting for providers Cortex can prove are behind", () => {
