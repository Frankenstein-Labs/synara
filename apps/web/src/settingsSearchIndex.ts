...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  // ── Appearance ───────────────────────────────────────────────────────────────
  {
    ...
    section: "appearance",
    title: "Theme",
    keywords: "Choose how Cortex looks across the app. dark light system color",
  },
  {
    id: "appearance:app-icon",
    section: "appearance",
    title: "App icon",
    keywords: "Choose the icon Cortex uses in the dock or taskbar desktop application logo.",
    target: null,
  },
  {
  ...
  },
  {
    ...
    keywords: "Use the operating system interface font throughout Cortex.",
  },
  {
  ...
  // ── Keybindings ───────────────────────────────────────────────────────────────
  {
    ...
    title: "Keybindings",
    keywords:
      "Every keyboard shortcut available in Cortex, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Cortex. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Cortex can safely update. upgrade cli",
  },
  {
