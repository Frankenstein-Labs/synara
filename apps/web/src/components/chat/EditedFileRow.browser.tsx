...
import type { EditorId, NativeApi } from "@cortex/contracts";
...
const WORKSPACE_ROOT = "/workspace/cortex";
...
describe("EditedFileRow", () => {
  it("opens the file in the preferred editor from the always-visible primary action", async () => {
    ...
    expect(openInEditor).toHaveBeenCalledWith(
      "/workspace/cortex/apps/web/src/components/chat/EditedFileRow.tsx",
      "cursor",
    );
  });
