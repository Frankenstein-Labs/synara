...
import type { GitBranch, GitStashInfoResult, GitStatusResult, NativeApi } from "@cortex/contracts";
            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                addBranchRecoveryToast({
                  ...
                  description:
                    "Cortex switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
