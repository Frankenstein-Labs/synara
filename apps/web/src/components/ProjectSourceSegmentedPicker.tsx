...
/**
 * The compact raised-thumb picker previously used for the Cortex/Studio switch,
        ...
        {PROJECT_SOURCES.map((source, index) => {
          ...
          return (
            <button
              ...
              title={
                sourceUnavailable ? "Update the Cortex server to add GitHub projects." : undefined
              }
              className={cn(
