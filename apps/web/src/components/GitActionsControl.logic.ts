...
import { isTemporaryWorktreeBranch, resolveUniqueCortexBranchName } from "@cortex/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueCortexBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@cortex/shared/git";
