...
import { isWorkspaceRootWithin, workspaceRootsEqual } from "@cortex/shared/threadWorkspace";
...
export const DEBUG_FEATURE_FLAGS_MENU_STORAGE_KEY = "cortex:show-debug-feature-flags-menu";
 ...
 * or create a new branch there without going through Cortex's branch picker, so its checked-out
