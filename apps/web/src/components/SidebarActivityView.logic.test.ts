...
describe("project filter", () => {
  ...
  it("merges every project-less chat container into one Cortex scope", () => {
...
describe("resolveActivityScope", () => {
  ...
  it("expands the Cortex chats scope to its container projects", () => {
...
describe("resolveThreadProjectLabel", () => {
  it("uses the project name for real projects and Cortex otherwise", () => {
    expect(
      resolveThreadProjectLabel({ kind: "project", name: "Cortex App", folderName: "cortex" }),
    ).toBe("Cortex App");
    expect(resolveThreadProjectLabel({ kind: "chat", name: "Chats", folderName: "chats" })).toBe(
      "Cortex",
    );
    expect(resolveThreadProjectLabel(undefined)).toBe("Cortex");
  });
});
