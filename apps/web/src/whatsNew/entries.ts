    ...
    features: [
      {
        ...
        description:
          "The app now starts from `~/.cortex`, carries the Cortex environment variables through the desktop and server runtime, and safely imports data from previous installations on first launch.",
      },
      {
        id: "desktop-platform-polish",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Cortex can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point Cortex at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
