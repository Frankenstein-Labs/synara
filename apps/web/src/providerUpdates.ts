...
// A provider whose latest version Cortex cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Cortex can actually assert are outdated.
