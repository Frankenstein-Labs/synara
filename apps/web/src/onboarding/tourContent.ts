// FILE: tourContent.ts
// Purpose: Copy and links for the "what Cortex can do" tour. Wording mirrors the public
//          docs (trycortex.com/docs) and changelog so onboarding and docs stay consistent.
...
export const CORTEX_DOCS_URL = "https://trycortex.com/docs";
...
export const TOUR_CARDS: ReadonlyArray<TourCard> = [
  {
    ...
    description:
      "Cortex sits around the agent runtimes you already trust: Claude Code, Codex, Cursor, Devin, Antigravity, Grok, Factory Droid, OpenCode, and Pi. The provider keeps its account, models, and limits. Cortex owns the durable task, environment, transcript, and delivery workflow around it.",
    highlights: [
      "Switch models mid-thread",
      "Hand a thread to another provider",
      "Usage for every provider",
    ],
    docsHref: `${CORTEX_DOCS_URL}/getting-started/providers`,
    icon: BotIcon,
  },
  {
    id: "tasks",
    ...
    docsHref: `${CORTEX_DOCS_URL}/workflows/worktrees`,
    icon: GitForkIcon,
  },
  {
    id: "review",
    ...
    docsHref: `${CORTEX_DOCS_URL}/workflows/pull-requests`,
  ...
  },
  {
    ...
    docsHref: `${CORTEX_DOCS_URL}/workflows/browser-verification`,
    icon: GlobeIcon,
  },
  {
    id: "automations",
    ...
    description:
      "Schedule recurring runs, attach a persistent goal to a thread so it keeps going after each clean turn, and let Cortex bring you back when something needs attention. Scheduled does not mean autonomous approval.",
    highlights: [
      "Interval, daily, cron schedules",
      "Natural-language stop conditions",
      "Thread goals",
    ],
    docsHref: `${CORTEX_DOCS_URL}/workflows/automations`,
    icon: ClockIcon,
  },
  {
    id: "gateway",
    label: "Agent Gateway",
    title: "Let agents operate Cortex itself",
    description:
    ...
    docsHref: `${CORTEX_DOCS_URL}/workflows/agent-gateway`,
    icon: TerminalIcon,
  },
  {
    id: "shortcuts",
    ...
    highlights: [],
    docsHref: `${CORTEX_DOCS_URL}/reference/keyboard-shortcuts`,
    icon: KeyboardIcon,
  },
];
