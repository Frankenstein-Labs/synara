...
// Layer: Web UI state
// Why: "Void" is Cortex's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@cortex/contracts";
...
const STORAGE_KEY = "cortex:void-space:v1";
