...
// Depends on: The public trycortex feedback endpoint.
...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Cortex felt slow" },
...
const DEFAULT_FEEDBACK_ENDPOINT = "https://www.trycortex.com/api/feedback";
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Cortex ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}
