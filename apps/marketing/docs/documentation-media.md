...
Use these rules for every screenshot, diagram, gallery, animation, and video added to Cortex documentation.
...
- `real` — a sanitized capture from the actual Cortex application;
...
<DocsImage
  ...
  alt="Two Cortex tasks using separate Git worktrees and branches"
  width={1440}
  height={900}
  provenance="diagram"
