...
description: Complete and verify a coding task in Cortex from a known repository state to a reviewed change.
---
...
Add the local repository to Cortex.
...
- Use a provider you have already verified outside Cortex
