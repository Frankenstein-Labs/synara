...
- **Checkpoints** let you revert a thread to an earlier state — Cortex refuses the revert while a turn is still running, so you can't pull the rug out from under an active agent.
