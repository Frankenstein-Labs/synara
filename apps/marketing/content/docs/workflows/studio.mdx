...
Studio is a dedicated Cortex workspace for long-running, agent-led work whose files and generated outputs matter more than a short interactive conversation. Use it to keep durable projects and their artifacts separate from routine repository tasks.
