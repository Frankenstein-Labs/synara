...
const HELP_PAGES = [
  ...
  },
  {
    ...
    requiredSections: [
      ...
      "Provider works directly but fails in Cortex",
  ...
  },
  {
    ...
    requiredSections: [
      ...
      "Integration targets the wrong Cortex instance",
  ...
  },
  {
    ...
    markers: [
      "rotate or revoke",
      "complete Cortex data directory",
      "Expected behavior",
      "Actual behavior",
