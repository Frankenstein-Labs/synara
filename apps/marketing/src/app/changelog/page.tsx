...
// Purpose: Public changelog — every Cortex release, newest first. Editorial,
...
export const metadata = pageMetadata({
  title: "Changelog — Cortex",
  description:
    "Every Cortex release: new providers, performance work, and the steady polish that makes the app faster and sturdier. Updated with each version.",
  path: "/changelog",
});
