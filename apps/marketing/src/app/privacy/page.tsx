...
// Purpose: Full privacy page — the detailed, honest account of what Cortex does
...
// Note: Claims verified against the cortex codebase. Keep them in sync with the
//       app: local SQLite, direct-to-provider, no Cortex account, explicit
...
export const metadata = pageMetadata({
  ...
  description:
    "Cortex's security and privacy boundary: local-first storage, direct-to-provider connections, no account, and anonymous analytics that are off by default.",
  path: "/privacy",
});
...
const RECEIVED_IF_OPTED_IN = [
  ...
  "Your OS, CPU architecture, and Cortex version",
...
const PRIVACY_JSONLD = [
  {
    ...
    description:
      "Cortex security and privacy details covering local-first storage, direct-to-provider connections, no Cortex account, and opt-in anonymous analytics.",
  },
  breadcrumbJsonLd([
    { name: "Cortex", path: "/" },
    ...
    <div className="flex min-h-screen flex-col bg-[var(--page-bg)] text-[var(--text-primary)]">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 pt-10 pb-20 sm:px-6 sm:pt-14">
        ...
        <p className="mt-5 text-[14px] leading-[1.7] text-[var(--text-secondary)] sm:text-[15px]">
          Cortex is a desktop app that runs on your machine and connects straight to the providers
          you already use. There&apos;s no Cortex account, no Cortex server holding your work, and
          your code or prompts are not sent to us during normal use. The only exception is feedback
          you explicitly write and submit through the Feedback Cortex dialog, together with the
        ...
        <Section title="Where your data lives">
          <p>
            ...
            your own device. Cortex runs a small server process <em>locally</em> on your machine to
            power the app — it is not a hosted cloud service, and your data never leaves your
            computer just by using Cortex.
          </p>
        </Section>

        <Section title="Where your prompts and code go">
          <p>
            When you chat with a model, Cortex connects <strong>directly</strong> to the provider
            ...
            <em>their</em> privacy terms. Cortex does not proxy, copy, or store that traffic on any
            server of ours.
          </p>
        </Section>
        ...
        <Section title="No account, no lock-in">
          <p>
            There&apos;s nothing to sign up for and no Cortex login. Want to open Cortex from your
        ...
        <Section title="Anonymous analytics — off by default">
          <p>
            Cortex can send <strong>anonymous, aggregate usage analytics</strong> (via PostHog) to
        ...
        <Section title="Feedback you choose to send">
          <p>
            The in-app <strong>Feedback Cortex</strong> dialog sends only when you press Submit. It
          ...
          <p>
            ...
            email provider to the Cortex maintainer for support and product improvement, rather than
        ...
        <Section title="Open source">
          <p>
            Cortex is open source under the MIT license. If a sentence on this page isn&apos;t
            enough, you can verify every claim yourself —{" "}
            <a
              href="https://github.com/Emanuele-web04/cortex"
              target="_blank"
