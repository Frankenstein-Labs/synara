// FILE: manifest.ts
// Purpose: Generates the web app manifest with Cortex identity, icons, and screenshots.
    ...
    screenshots: [
      {
        ...
        type: "image/png",
        form_factor: "wide",
        label: "Cortex desktop workspace in light mode",
      },
      {
        ...
        type: "image/png",
        form_factor: "wide",
        label: "Cortex desktop workspace in dark mode",
      },
    ],
  };
}
