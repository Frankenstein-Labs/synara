...
export const metadata = pageMetadata({
  title: "Sponsor — Cortex",
  description:
    "Sponsor Cortex on GitHub Sponsors. Monthly tiers from $5 to $499, plus custom one-time amounts, fund development, reliable releases, and docs for the free, open-source desktop app.",
  path: "/sponsor",
});
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 pt-10 pb-20 sm:px-6 sm:pt-14">
        <header>
          ...
          <h1 className="mt-2.5 text-[1.35rem] font-medium leading-[1.2] tracking-[-0.03em] sm:text-[1.5rem]">
            Cortex is free. Sponsorship is what keeps it that way.
          </h1>
          <p className="mt-3 max-w-3xl text-[13.5px] leading-[1.65] text-[var(--text-secondary)]">
            Cortex Desktop is open source under the MIT license, with no paid tier, no account, and
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 space-y-5">
            <QA question="Does sponsoring unlock features?">
              No. Cortex is MIT-licensed and every feature is free for everyone, sponsor or not.
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-[var(--divide)] pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-[12px] text-[var(--text-tertiary)]">
            Not able to sponsor? Starring the repo and telling someone about Cortex genuinely helps
            too.
          </p>
