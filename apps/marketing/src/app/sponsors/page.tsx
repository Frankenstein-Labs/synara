...
//          Cortex, grouped by tier. The pitch and the tiers live at /sponsor.
...
export const metadata = pageMetadata({
  title: "Sponsors — Cortex",
  description:
    "The people and companies funding Cortex, the free and open-source command center for agentic development. Thank you to every sponsor and one-time donor.",
  path: "/sponsors",
});
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 pt-10 pb-20 sm:px-6 sm:pt-14">
        <header>
          ...
          <h1 className="mt-2.5 text-[1.35rem] font-medium leading-[1.2] tracking-[-0.03em] sm:text-[1.5rem]">
            The people keeping Cortex free
          </h1>
          <p className="mt-3 max-w-3xl text-[13.5px] leading-[1.65] text-[var(--text-secondary)]">
            {count === 0
              ? "Cortex is funded entirely by sponsorship. This page is where sponsors get listed — it's empty right now, so the first name on it is available."
              : "Cortex is funded entirely by sponsorship — there's no paid tier and no company behind it. Everyone below chose to fund work they could otherwise use for free. Thank you."}
          </p>
        </header>
        ...
        <section className="mt-12 border-t border-[var(--divide)] pt-8">
          ...
          <p className="mt-2 max-w-3xl text-[13px] leading-[1.65] text-[var(--text-secondary)]">
            Sponsoring Cortex gets you listed here. Every tier runs through GitHub Sponsors — the
