...
export const SITE_URL = "https://www.trycortex.com";
...
export const GITHUB_REPO_URL = "https://github.com/Emanuele-web04/cortex";
...
export const SITE_IMAGES = {
  ...
  og: "/og.png",
  lightScreenshot: "/cortex-ui-light.png",
  darkScreenshot: "/cortex-ui-dark.png",
};
...
export function changelogCollectionJsonLd(entries: readonly ChangelogEntry[]) {
  return {
    ...
    name: "Cortex changelog",
    url: absoluteUrl("/changelog"),
    description:
      "Release notes for Cortex, including provider support, coding-agent workflows, reliability, performance, and installer updates.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    mainEntity: {
      "@type": "ItemList",
...
export function releaseJsonLd(entry: ChangelogEntry) {
  ...
  return {
    ...
    headline: `Cortex ${entry.version} release notes`,
    name: `Cortex ${entry.version} changelog`,
    url: absoluteUrl(`/changelog/v${entry.version}`),
    description: `What's new in Cortex ${entry.version}: ${highlights}.`,
...
export function sponsorJsonLd(
  ...
  return {
    ...
    description:
      "Sponsor Cortex through GitHub Sponsors. Monthly tiers from $5 to $499 plus custom one-time amounts fund development, releases, and docs for the free, open-source desktop app.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    primaryImageOfPage: absoluteUrl(SITE_IMAGES.og),
    mainEntity: {
      "@type": "OfferCatalog",
      name: "Cortex sponsorship tiers",
...
export function sponsorsPageJsonLd(sponsors: ReadonlyArray<{ name: string; url: string }>) {
  return {
    ...
    name: "Cortex sponsors",
    url: absoluteUrl("/sponsors"),
    description:
      "The people and companies funding Cortex, the free and open-source command center for agentic development.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    primaryImageOfPage: absoluteUrl(SITE_IMAGES.og),
    mainEntity: {
