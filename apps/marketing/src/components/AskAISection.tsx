...
// Purpose: Lets visitors ask external AI assistants whether Cortex fits them.
    ...
    <section className="border-t border-[var(--divide)] py-14 sm:py-20">
      <div className={container}>
        <div className="text-center">
          ...
          <p className={body}>
            Ask ChatGPT, Claude, or Gemini to evaluate Cortex from the source of truth—this site and
            the GitHub repo. The prompt is specific so the answer reflects what Cortex actually
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            {aiLinks.map(({ label, appHref, webHref, icon: Icon, iconClass, copyPrompt }) => (
              <a
                ...
                aria-label={
                  copyPrompt
                    ? `${label} about Cortex — copies the prompt to paste`
                    : `${label} about Cortex`
                }
              >
