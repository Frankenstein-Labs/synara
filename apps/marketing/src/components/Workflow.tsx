    ...
    <section className="relative overflow-hidden border-t border-[var(--divide)] py-14 sm:py-20">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        <SplitShowcase
          ...
          description="Change the provider while preserving the task environment and the context Cortex passes forward. Review the working tree before and after every handoff."
          reverse
        >
          <HandoffChatMock />
        </SplitShowcase>
        ...
        >
          <div className="overflow-hidden rounded-lg ring-1 ring-black/5 sm:rounded-xl dark:ring-white/10">
            ...
            <img
              src="/browser-syn.png"
              alt="Cortex browser verification beside a coding-agent task"
