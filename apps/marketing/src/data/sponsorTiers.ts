...
export const SPONSOR_TIERS: readonly SponsorTier[] = [
  {
    ...
    label: "Supporter",
    plural: "Supporters",
    tagline: "Support my open-source work and help keep Cortex Desktop free.",
  ...
  },
  {
    ...
    label: "Backer",
    plural: "Backers",
    tagline: "Support Cortex's development and get your name on the sponsors page.",
  ...
  },
  {
    ...
    tagline: "Support Cortex as a project sponsor.",
    perks: [
      "Everything in Backer",
      "Your name listed on the Cortex sponsors page",
      "Thank you post on X",
    ],
  },
  {
    ...
    tagline: "Support Cortex at a higher level and get more visible recognition.",
    perks: [
      "Everything in Project sponsor",
      "Featured logo placement on the sponsors page, the Cortex home page, and my portfolio",
      "Thank you post on X",
    ],
  },
  {
    ...
    label: "Partner",
    plural: "Partners",
    tagline: "Premium sponsorship for companies that want to support Cortex visibly.",
    perks: [
      "Logo + link in the main sponsor banner on the Cortex sponsor page and home page, plus my portfolio",
...
export const SPONSOR_FUNDING_USES = [
  {
    ...
    body: "The hours that go into new providers, worktree flows, and the parts of Cortex that are tedious to get right.",
  },
  {
