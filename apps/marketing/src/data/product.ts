...
export const PRODUCT_HERO_DESCRIPTION =
  "Cortex is the local-first command center for serious agentic work—run every coding agent in parallel and ship without losing context.";

export const PRODUCT_META_DESCRIPTION =
  "Cortex is a free, open-source, local-first workspace for coding agents with separate tasks, Git worktrees, terminals, browser verification, diffs, handoffs, and pull-request delivery.";

export const PRODUCT_DESCRIPTION =
  "Cortex is a free, open-source, local-first workspace and control plane for coding agents. Run Claude Code, Codex, OpenCode, Cursor, Antigravity, Grok Build, Devin CLI, Pi, and Factory Droid across separate tasks with terminals, browser verification, diffs, Git worktrees, handoffs, and pull-request delivery in one desktop app.";
