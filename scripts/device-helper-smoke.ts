...
import { decodeDeviceFrame } from "@cortex/shared/deviceFrame";
import {
...
async function main(): Promise<void> {
  ...
  // comes from @cortex/shared so this build lands in the same directory the
  ...
  try {
    ...
    const socketDir = mkdtempSync(join(tmpdir(), "cortex-device-smoke-"));
