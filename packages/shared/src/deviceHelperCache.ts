 ...
 *
 * This lives in `@cortex/shared` because two independent callers derive the
...
/** `~/Library/Caches/cortex/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "cortex-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "CORTEX_DEVICE_HELPER_SOURCE_DIR";
