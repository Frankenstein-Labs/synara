...
export interface ProviderDescriptor {
  ...
  /** Cortex docs page covering install, sign-in, and verification for this runtime. */
...
export const PROVIDER_DESCRIPTORS = defineProviderDescriptors([
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/codex",
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/claude-code",
    supportsNativeTurnSteering: true,
    usage: {
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/cursor",
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/antigravity",
    supportsNativeTurnSteering: false,
    usage: {
      signInCommand: "agy",
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/grok",
    supportsNativeTurnSteering: false,
    usage: {
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/factory-droid",
    supportsNativeTurnSteering: false,
    usage: {
      signInCommand: "droid",
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/opencode",
    supportsNativeTurnSteering: false,
    usage: {
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/pi",
    supportsNativeTurnSteering: true,
    usage: {
      signInCommand: "pi",
  ...
  },
  {
    ...
    available: true,
    setupDocsHref: "https://trycortex.com/docs/providers/devin",
    supportsNativeTurnSteering: false,
    usage: {
