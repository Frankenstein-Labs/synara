...
export const MIGRATION_DIVERGENCE_CONSENT_ENV = "CORTEX_MIGRATION_DIVERGENCE_CONSENT";
export const MIGRATION_RUNTIME_SOURCE_DIGEST_ENV = "CORTEX_MIGRATION_RUNTIME_SOURCE_DIGEST";
...
export const MIGRATION_DIVERGENCE_CONSENT_REQUIRED_PREFIX =
  "CORTEX_MIGRATION_DIVERGENCE_CONSENT_REQUIRED=";
export const MIGRATION_SCHEMA_TOO_NEW_BLOCK_PREFIX = "CORTEX_MIGRATION_SCHEMA_TOO_NEW=";
