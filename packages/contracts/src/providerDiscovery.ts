...
// Unified cross-provider skills catalog (Cortex portable skills). Descriptors use
// `scope` to carry the origin label ("cortex", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  cortexSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
