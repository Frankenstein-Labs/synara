...
// the shareable activity card. All metrics are backed by Cortex's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Cortex.
...
// Token totals come from Cortex's projected context-window updates. `available`
